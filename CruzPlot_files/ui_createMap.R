        ...
        tabPanel(
          ...
          fluidRow(
            box(
              ...
              fluidRow(
                column(6, selectInput("label.title.font", label = h5("Title font"), 
                                      choices = font.family, selected = 1)),
                column(6, numericInput("label.title.size", label = h5("Title size"), 
            ...
            box(
              ...
              fluidRow(
                column(6, selectInput("label.axis.font", label = h5("Axis label font"), 
                                      choices = font.family, selected = 1)),
                column(6, numericInput("label.axis.size", label = h5("Axis label size"), 
              ...
              fluidRow(
                box(
                  ...
                  conditionalPanel(
                    ...
                    helpText("2) Download bathymetric data from NOAA website based on lat/lon of map.", 
                             tags$br(), 
                    ...
                    conditionalPanel(
                      ...
                      textInput("depth.res", h5("Bathymetric data resolution, in minutes (range: 0-60)"), 
                                value = "10")
                    )
                  )
                )
            ...
            box(
              ...
              conditionalPanel(
                ...
                fluidRow(
                  ...
                  column(6, selectInput("grid.line.type", label = h5("Line type"), 
                                        choices = list("Solid" = 1, "Dash" = 2, "Dot" = 3, "Dot-dash" = 4, "Long dash" = 5, 
                                                       "Dot-long dash" = 6),
                                        selected = 1))
                )
              )
