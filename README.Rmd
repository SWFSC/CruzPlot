...
Note that CruzPlot depends on swfscDAS, and thus you should ensure that swfscDAS is installed and updated as well. If your version of CruzPlot is outdated, running the above command will install the new version. However, if you want to reinstall the same version of CruzPlot, you can run:
