...
server <- function(input, output, session) {
  ...
  source(file.path("cruzSpeciesCodes.R"), local = TRUE, chdir = TRUE)
  ...
  #----------------------------------------------------------------------------
  ### Non-DAS data tab
  source(file.path("cruzNonDas.R"), local = TRUE, chdir = TRUE)
  ...
  source(file.path("cruzDisplaySymbolProp.R"), local = TRUE, chdir = TRUE)
  source(file.path("server_reactiveValues.R"), local = TRUE, chdir = TRUE)
  ...
  plotMap <- reactive({
    function() {
      ...
      # source("cruzDraw.R", local = TRUE, chdir = TRUE)
      ##############################################################################
      ##############################################################################
